module ApplicationHelper
  ...
  def quiz_mode_index_dropdown(object)
    link_to url_for(controller: 'quiz_mode', action: 'take_quiz', id: object.id), class: "btn btn-primary btn-md",  data: { action: I18n.t('edit'), dismiss: I18n.t('cancel') }, :title => I18n.t('edit') do
      content_tag(:i, nil, class: "fa fa-pencil")
    end
  end
